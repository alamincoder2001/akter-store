		...
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSaleReturnDetails">
				...
				<div class="form-group">
					...
					<v-select v-bind:options="categories" v-model="selectedCategories" label="ProductCategory_Name"></v-select>
				</div>
		...
		methods: {
			...
			getSaleReturnDetails(){
				let filter = {
					...
					categoryId: this.selectedCategories == null || this.selectedCategories.ProductCategory_SlNo  == '' ? '' : this.selectedCategories.ProductCategory_SlNo,
